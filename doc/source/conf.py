# -*- coding: utf-8 -*-
#
# CAMMAC documentation build configuration file, created by
# sphinx-quickstart on Thu Apr 30 09:09:46 2020.
#
...
html_short_title = "CAMMAC {0}".format(release)
...
man_pages = [
    ('index', 'pac', u'CAMMAC Documentation',
     [u'Sénési'], 1)
]
...
intersphinx_mapping = {
    ...
    'climaf' : ('https://climaf.readthedocs.io/en/latest/', None),
}


# -- Custom Document processing ----------------------------------------------

# Voir EsmValTool pour ci-dessous
#import gensidebar
#gensidebar.generate_sidebar(globals(), "CAMMAClib")
